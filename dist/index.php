...
<html lang="es">
    <head>
        ...
        <meta name="description" content="LachFilms, es una productora de material fotográfico y audiovisual ubicada en el estado de Puebla. Ofrece diferentes servicios, entre ellos tomas areas con Dron. Cuenta con expertos en diferentes estilos de fotografía dependiendo de las necesidades del cliente"> 
        <meta name="author" content="Create-It">
        <meta name="keywords" content=" LachFilms, lachfilms, Lach, Films, productora, fotográfica, visual, contenido, videos, redes sociales, dron, drones, tomas aereas, Puebla, Zaragoza, productos, fotografía">
        ...
        <main data-barba="container" data-barba-namespace="home-section">
            ...
            <div class="card">
                ...
                <div class="card-butron">
                    <a href="#about-us" class="animated-button thar-three"
                        >Contactanos</a
                    >
                </div>
            </section>
...
<<<<<<< HEAD:dist/index.php
                <a href="./pages/videos_productos.html" class="swiper-slide">
                    <img src="./images/slider/social.jpg" alt="Social">
                </a>
                <a href="./pages/videos_productos.html" class="swiper-slide">
                    <img src="./images/slider/turismo.jpg" alt="Turismo">
                </a>
                <a href="./pages/videos_productos.html" class="swiper-slide">
                    <img src="./images/slider/aereo.jpg" alt="Aereo">
                </a>
                <a href="./pages/videos_productos.html" class="swiper-slide">
                    <img src="./images/slider/productos.jpg" alt="Productos">
                </a>
=======
                    <a href="./pages/videos_social.html" class="swiper-slide">
                        <img src="./images/slider/social.jpg" alt="Social">
                    </a>
                    <a href="./pages/videos_turismo.html" class="swiper-slide">
                        <img src="./images/slider/turismo.jpg" alt="Turismo">
                    </a>
                    <a href="./pages/videos_aereo.html" class="swiper-slide">
                        <img src="./images/slider/aereo.jpg" alt="Aereo">
                    </a>
                    <a href="./pages/videos_productos.html" class="swiper-slide">
                        <img src="./images/slider/productos.jpg" alt="Productos">
                    </a>
>>>>>>> 3b607f7c675834ff160f00536bd39243dca8d3e5:dist/index.html
                </div>
            ...
            <div class="portafolio-info">
                ...
                <div class="portafolio-container">
                    <div class="d-v d-social">
                        <a href="./pages/social.html" id="btn-social" class="filtro-social">
                            <div class="info"></div>
                                <h3>SOCIAL</h3</div>>
                                <p class="p-po</div>rtafolio">
                                    No te arre</div>pentirás de vivir la experiencia de una sesión fotografíca profesional. Preserva esos momentos tan emocio</div>nantes. Bodas, festivales, fiestas y muchos eventos más.
                                </p>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="d-aereo">
                        <a href="./pages/aereo.html" id="btn-aereo" class="filtro-aereo">
                            <div class="info">
                                <h3>AEREO</h3>
                                <p class="p-portafolio">
                ...
                <div class="d-v d-turismo">
                    <a href="./pages/turismo.html" id="btn-turismo" class="filtro-turismo">
                        <div class="info">
                            <h3>TURISMO</h3>
                            <p class="p-portafolio">
...
<footer class="footer" id="nosotros">
    <div class="footer__item" id="f-u">
        ...
        <span class="footer__span">!Puedes encontrarnos aqui!</span><br>
        <iframe id="map"
