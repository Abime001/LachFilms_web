...
<html lang="en">
    <head>
        ...
        />
        <meta name="description" content="LachFilms, productora fotográfica y audiovisual. Sitio desarrollado por Create-It"> 
    ...
    <body>
        ...
        <nav>
            <ul class="menu">
                ...
                <li class="item lach" alt="LachFilms"><label>LACH FILMS</label></li>
                <li class="toggle">
        ...
        <div id="home" class="video">
            <video autoplay muted loop width="100%" height="100%" alt="Lach Films video de presentación"> 
                <source src="video/logo animado colores.mp4" />
            </video>
        </div>
        ...
        <section id="travel">
            <video
                ...
                muted
                loop
                width="100%" alt="Servicios ofertados por Lach Films"
            ></video>
        </section>
            ...
            <div class="footer__item" id="f-u">
                ...
                <div id="footer__map">
                    <iframe
                        ...
                        allowfullscreen=""
                        loading="fast" alt="Ubicación de Lach Films, en google maps"
                    ></iframe>
                </div>
            </div>
